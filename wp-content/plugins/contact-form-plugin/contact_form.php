...
if( ! function_exists( 'cntctfrm_settings' ) ) {
	function cntctfrm_settings() {
		...
		$cntctfrm_option_defaults = array(
			...
			'cntctfrm_form_error' => array( 'en' => __( "Please fill in all the fields.", 'contact_form' ) ),
	...
	function cntctfrm_display_form( $atts = array( 'lang' => 'en' ) ) {
		...
		if( true !== $cntctfrm_result) { 
			...
			if( isset( $error_message['error_name'] ) ) {
				//$content .= '<div class="error">'.$error_message['error_name'].'</div>';
			}
			$content .= '
					<input class="text" type="text" size="40" value="'.$name.'" name="cntctfrm_contact_name" id="cntctfrm_contact_name" placeholder="NAME" />
				';
			...
			if( isset( $error_message['error_email'] ) ) {
				//$content .= '<div class="error">'.$error_message['error_email'].'</div>';
			}
			$content .= '
					<input class="text" type="text" size="40" value="'.$email.'" name="cntctfrm_contact_email" id="cntctfrm_contact_email" placeholder="EMAIL" />
			...
			if( isset( $error_message['error_message'] ) ) {
				//$content .= '<div class="error">'.$error_message['error_message'].'</div>';
			}
			$content .= '
					<textarea rows="5" cols="30" name="cntctfrm_contact_message" id="cntctfrm_contact_message" placeholder="MESSAGE">'.$message.'</textarea>
				';
			...
			if( isset( $error_message['error_form'] ) ) { 
				$content .= '<div class="error">'.$error_message['error_form'].'</div>';
				}
			...
			$content .= '
					...
					<input type="submit" value="'. $cntctfrm_options['cntctfrm_submit_label'][$lang]. '" class="button" /> 
